...
interface EditMistakeSheetProps {
  bottomSheetRef: React.RefObject<BottomSheet | null>;
  mistake: Mistake | null;
  onSave: (id: string, form: MistakeFormData) => void;
}
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Edit Mistake</Text>
