...
import { INITIAL_STRATEGY_FORM, StrategyFormData } from "../../types/strategy";

interface AddStrategySheetProps {
  bottomSheetRef: React.RefObject<BottomSheet | null>;
  onAdd: (form: StrategyFormData) => void;
}

export function AddStrategySheet({
  bottomSheetRef,
  onAdd,
}: AddStrategySheetProps) {
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Add New Strategy</Text>
